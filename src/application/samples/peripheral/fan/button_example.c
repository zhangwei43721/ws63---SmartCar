...
#define BSP_LED 12      // RED
#define BUTTON1_GPIO 14 // 按键1
#define BUTTON2_GPIO 15 // 按键2
...
void led_init(void)
{
    ...
    uapi_pin_set_pull(BSP_LED,PIN_PULL_TYPE_UP);
...
static void *button_task(const char *arg)
{
    ...
    while (1) {
        ...
        //     uapi_gpio_set_val(BSP_LED, GPIO_LEVEL_LOW);
        uapi_gpio_set_val(BSP_LED, GPIO_INTERRUPT_HIGH);
        osal_msleep(10);
    }
