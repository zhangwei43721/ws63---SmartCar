...
typedef enum { BSP_SSD1306_COLOR_BLACK = 0x00, BSP_SSD1306_COLOR_WHITE = 0x01 } BspSsd1306Color;

typedef enum { BSP_SSD1306_OK = 0x00, BSP_SSD1306_ERR = 0x01 } BspSsd1306Error;
